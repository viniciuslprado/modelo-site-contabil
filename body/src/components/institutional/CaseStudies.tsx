...
const CaseStudies: React.FC = () => {
  return (
    <section id="cases" className="py-24 bg-transparent transition-colors">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {CASES.map((c, i) => (
            <div key={i} className="group p-8 border border-slate-100 dark:border-white/5 rounded-sm hover:border-gold/50 transition-all duration-500 bg-transparent">
