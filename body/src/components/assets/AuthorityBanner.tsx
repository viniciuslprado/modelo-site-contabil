...
const AuthorityBanner: React.FC = () => {
  return (
   <div className="bg-slate-50 py-12 border-y border-slate-100 transition-colors overflow-hidden">
      <div className="container mx-auto px-6">
      <p className="text-center text-[10px] uppercase tracking-[0.4em] font-bold text-primary mb-12 italic">Credenciais e Atuação Estratégica</p>
        <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20">
          ...
          <div className="flex flex-col items-center group">
             <div className="w-12 h-12 mb-3 flex items-center justify-center border-2 border-gold/20 rounded-full group-hover:border-gold transition-colors">
               <span className="font-serif font-bold text-[10px] text-primary text-center block absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">SESCON</span>
             </div>
