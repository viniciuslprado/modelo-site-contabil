...
const Testimonials: React.FC = () => {
  ...
  return (
    <section id="depoimentos" className="py-24 text-white relative overflow-hidden bg-transparent">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {TESTIMONIALS.map((t, idx) => (
              ...
              >
                <div className="backdrop-blur-sm border border-white/10 p-12 rounded-sm text-center bg-transparent">
          ...
          <div className="flex justify-center gap-3 mt-12">
            {TESTIMONIALS.map((_, idx) => (
              <button 
                ...
                className={`h-2 rounded-full transition-all duration-300 ${idx === active ? 'w-12' : 'w-2'}`}
              />
            ))}
          </div>
        </div>
