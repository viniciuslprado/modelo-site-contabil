    ...
    <section className="py-20 bg-slate-50 transition-colors">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="bg-white p-10 border border-slate-100 shadow-xl group hover:border-gold/50 transition-all">
            ...
            <h3 className="text-3xl font-serif text-navy-dark mb-4">Abrir Empresa</h3>
            ...
            <button className="w-full bg-navy-dark text-white py-4 font-bold uppercase tracking-widest text-[10px] hover:bg-gold transition-all">
              Começar Agora
            </button>
          </div>
